    ...
    <div class="max-w-screen-tainacan mx-auto px-8 lg:px-0">
        <div class="grid grid-cols-1 gap-8 lg:grid-cols-2 lg:gap-16 lg:justify-between">
            ...
            <div class="lg:order-first">
                ...
                <p class="text-black lg:text-lg mb-4 font-normal font-lato lg:pr-6">Como parte das pesquisas do Laboratório de Extensão e
                ...
                <a class="inline-flex px-5 py-3 bg-logo-blue text-white rounded-lg text-base font-bold hover:shadow-soft-shadow" href="/acervo">Acesse o Acervo</a>
            </div>
        </div>
    </div>
</section>
...
<section class="w-full bg-white py-20 font-lato">
    <div class="max-w-screen-tainacan w-full mx-auto px-8 lg:px-0">
        ...
        <div class="grid grid-cols-2 gap-x-5 gap-y-9 lg:grid-cols-4 lg:gap-10 mb-9">
            <div class="w-full">
                <img class="w-full max-w-full lg:h-80 shadow-soft-shadow rounded-lg object-cover mb-4 h-56"
                    src="<?php echo get_template_directory_uri(  ) .  '/resources/images/img-model-6.jpg' ?>">
                <h3 class="text-title-gray text-base font-bold mb-2">Raphael Samú e os mosaicos murais: experiências
                    em arte pública</h3>
                <p class="text-subtitle-gray mb-4 text-sm font-normal">Marcela Belo Gonçalves</p>
                <div class="w-full">
        ...
        <div class="flex justify-center">
            <a class="px-5 py-3 bg-logo-blue text-white rounded-2xl text-base font-bold hover:shadow-soft-shadow" href="<?php echo home_url('/biblioteca-virtual')?>">Veja todas as
                publicações</a>
        </div>
    </div>
</section>
...
<section class="w-full py-20 font-lato">
    <div class="max-w-screen-tainacan w-full mx-auto px-8 lg:px-0">
        ...
        <div class="grid grid-cols-1 lg:grid-cols-4 gap-4 lg:gap-8">
            <a href="#" class="transition duration-500 lg:p-6 p-5 bg-white shadow-soft-shadow rounded-2xl border border-medium-gray group hover:bg-logo-blue flex flex-col justify-center">
                <div class="flex items-center space-x-1 mb-1">
                    <h5 class="text-2xl font-bold text-title-gray uppercase group-hover:text-white">O projeto</h5>
                    <div>
                        <svg xmlns="http://www.w3.org/2000/svg" height="32px" viewBox="0 -960 960 960" width="32px" fill="currentColor" class="text-title-gray group-hover:text-white">
            ...
            <a href="/acervo" class="transition duration-500 lg:p-6 p-5 bg-white shadow-soft-shadow border border-medium-gray rounded-2xl group hover:bg-logo-blue flex flex-col justify-center">
                <div class="flex items-center space-x-1 mb-1">
            ...
            <a href="/biblioteca-virtual" class="transition duration-500 lg:p-6 p-5 bg-white shadow-soft-shadow border border-medium-gray rounded-2xl group hover:bg-logo-blue flex flex-col justify-center">
                <div class="flex items-center space-x-1 mb-1">
            ...
            <a href="#" class="transition duration-500 lg:p-6 p-5 bg-white shadow-soft-shadow border border-medium-gray rounded-2xl group hover:bg-logo-blue flex flex-col justify-center">
                <div class="flex items-center space-x-1 mb-1">
                    <h5 class="text-2xl font-bold text-title-gray uppercase group-hover:text-white">Itinerários temáticos</h5>
                    <div>
                        <svg xmlns="http://www.w3.org/2000/svg" height="32px" viewBox="0 -960 960 960" width="32px" fill="currentColor" class="text-title-gray group-hover:text-white">
                            <path d="M504-480 320-664l56-56 240 240-240 240-56-56 184-184Z" />
                        </svg>
                ...
                <p class="text-subtitle-gray group-hover:text-white">Acesse sugestões de itinerários pelos municípios, de maneira a conhecer algumas obras. (Em breve)</p>
            </a>
            <a href="#" class="transition duration-500 lg:p-6 p-5 bg-white shadow-soft-shadow border border-medium-gray rounded-2xl group hover:bg-logo-blue flex flex-col justify-center">
                <div class="flex items-center space-x-1 mb-1">
                    <h5 class="text-2xl font-bold text-title-gray uppercase group-hover:text-white">Educativo</h5>
                    <div>
                        <svg xmlns="http://www.w3.org/2000/svg" height="32px" viewBox="0 -960 960 960" width="32px" fill="currentColor" class="text-title-gray group-hover:text-white">
                            <path d="M504-480 320-664l56-56 240 240-240 240-56-56 184-184Z" />
                        </svg>
                ...
                <p class="text-subtitle-gray group-hover:text-white">Materiais preparados para professores do Ensino Básico, para auxílio em sala de aula. (Em breve)</p>
            </a>
            <a href="#" class="transition duration-500 lg:p-6 p-5 bg-white shadow-soft-shadow border border-medium-gray rounded-2xl group hover:bg-logo-blue flex flex-col justify-center">
                <div class="flex items-center space-x-1 mb-1">
            ...
            <a href="#" class="transition duration-500 lg:p-6 p-5 bg-white shadow-soft-shadow border border-medium-gray rounded-2xl group hover:bg-logo-blue flex flex-col justify-center">
                <div class="flex items-center space-x-1 mb-1">
                    <h5 class="text-2xl font-bold text-title-gray uppercase group-hover:text-white">Colabore</h5>
                    <div>
                        <svg xmlns="http://www.w3.org/2000/svg" height="32px" viewBox="0 -960 960 960" width="32px" fill="currentColor" class="text-title-gray group-hover:text-white">
                            <path d="M504-480 320-664l56-56 240 240-240 240-56-56 184-184Z" />
                        </svg>
                ...
                <p class="text-subtitle-gray group-hover:text-white">Faça sua contribuição de uma nova obra não mapeada em nosso acervo. (Em breve)</p>
            </a>
        </div>
