    ...
    <div class="max-w-5xl w-full mx-auto">
        <div class="w-full flex">
            <div class="w-1/2 pr-10">
                <h2 class="font-black text-6xl mb-5 text-black">O repositório da arte pública capixaba</h2>
                <p class="text-black text-lg mb-10 font-normal">Como parte das pesquisas do Laboratório de Extensão e
            ...
            <div class="w-1/2">
                <div class="w-full">
                    <div class="flex w-full">
                        <img src="/wp-content/themes/tainacan-theme/resources/images/img-model-1.png"
                            class="w-1/2 transform transition-transform duration-300 ease-in-out hover:scale-110">
                        <img src="/wp-content/themes/tainacan-theme/resources/images/img-model-2.png"
                            class="w-1/2 transform transition-transform duration-300 ease-in-out hover:scale-110">
                    </div>
                    <div class="flex w-full">
                        <img src="/wp-content/themes/tainacan-theme/resources/images/img-model-1.png"
                            class="w-1/3 transform transition-transform duration-300 ease-in-out hover:scale-110">
                        <img src="/wp-content/themes/tainacan-theme/resources/images/img-model-2.png"
                            class="w-1/3 transform transition-transform duration-300 ease-in-out hover:scale-110">
                        <img src="/wp-content/themes/tainacan-theme/resources/images/img-model-2.png"
                            class="w-1/3 transform transition-transform duration-300 ease-in-out hover:scale-110">
...
<section class="w-full bg-white py-20 font-lato">
    <div class="max-w-5xl w-full mx-auto">
        <div class="w-full">
            <h2 class="text-title-gray text-4xl font-black mb-10">Biblioteca Virtual</h2>
            <p class="text-lg text-black font-normal mb-12">Acesse livros e publicações criadas a partir de pesquisas
                ...</p>
        </div>
        <div class="w-full flex gap-10 mb-20">
            <div class="w-1/4">
                <div class="w-full">
                    <img class="w-full max-w-full h-80 shadow-soft-shadow rounded-lg object-cover mb-5"
                        src="/wp-content/themes/tainacan-theme/resources/images/img-model-6.jpg">
                    <h3 class="text-title-gray text-base font-bold mb-2">Raphael Samú e os mosaicos murais: experiências
                        em arte pública</h3>
                    <p class="text-subtitle-gray mb-5 text-sm font-normal">Marcela Belo Gonçalves</p>
                    <div class="w-full">
                        <a class="px-5 py-2 bg-white text-logo-blue border border-logo-blue rounded-lg text-base font-bold transition-all duration-500 hover:bg-logo-blue hover:text-white"
...
<section class="w-full py-20 font-lato">
    <div class="max-w-5xl w-full mx-auto">
        <h2 class="text-title-gray text-4xl font-black mb-10">Mapa do site</h2>
...
<section class="w-full py-20 font-lato">
    <div class="max-w-5xl w-full mx-auto">
        <h2 class="text-title-gray text-4xl font-black mb-10">Contato</h2>
        <div class="w-full flex">
            <div class="w-2/3">
            ...
            <div class="1/3">
                <ul class="w-full p-0">
                    <li class="w-full flex gap-3 mb-3 items-center text-title-gray text-xl font-normal">
...
<section class="w-full py-20 font-lato">
    <div class="max-w-5xl w-full mx-auto">
        <div class="w-full flex max-w-full flex-nowrap gap-5">
            ...
            <img src="/wp-content/themes/tainacan-theme/resources/images/ufes.png">
            <img src="/wp-content/themes/tainacan-theme/resources/images/leena.png">
            <img src="/wp-content/themes/tainacan-theme/resources/images/sectides.png">
            <img src="/wp-content/themes/tainacan-theme/resources/images/cnpq.png">
